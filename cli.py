...
def main():
    ...
    parser.add_argument('--level', '-l', type=int, required=True, help='Max depth of the recursive scrape.')
    parser.add_argument('--width', '-w', type=int, required=True, help='Max urls to scrape per html page.')
    ...
    parser.add_argument('--ignore_ssl_verification', action='store_true', help="Scrape html even if ssl verification failed.")
